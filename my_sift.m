function [descriptors] = my_sift(imageFile)
% [descriptors] = my_sift(imageFile)
...
% Pre-processed with whitening, normalization, and histogram equalization
...
% siftWin32.exe is a excution file
if isunix
    command = '!./sift ';
else
    command = '!siftWin32 ';
